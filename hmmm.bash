...
_hmm()
{
    ...
    opts=" \
###MINIFY-ACTIONS### \
 attach build cleanup commit control enter export fork get-details get-http get-https get-image get-log get-pid get-port get-source import init install kill pull push reload restart run serve snapshot spawn ssh start status stop tag \
    -h --help \
    -a --actions \
    -i --info \
    -f --force \
